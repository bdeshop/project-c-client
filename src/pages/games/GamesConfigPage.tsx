      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative overflow-hidden rounded-[2.5rem] bg-white/5 backdrop-blur-xl p-10 shadow-2xl border border-white/10 mb-10 animate-fade-in">
          ...
          <div className="relative flex flex-col md:flex-row items-center gap-8">
            <div className="flex h-24 w-24 items-center justify-center rounded-3xl bg-gradient-to-br from-yellow-400 to-yellow-500 text-gray-900 shadow-2xl shadow-yellow-400/20 ring-4 ring-white/10">
              <Gamepad2 size={48} />
            </div>
            <div className="text-center md:text-left">
              ...
              <p className="mt-3 text-lg font-bold text-gray-400 tracking-wide uppercase">
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-[2rem] shadow-2xl overflow-hidden">
          <div className="border-b border-white/10 px-8 py-6">
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-br from-yellow-400 to-yellow-500 text-gray-900">
                {activeItem.icon}
              </div>
